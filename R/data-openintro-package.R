...
#' @references OpenIntro Statistics,
#' \href{http://www.openintro.org/os}{openintro.org/os}
...
#' \dQuote{dollar} appeared in the email.}
#'   \item{winner}{Indicates
#' whether \dQuote{winner} appeared in the email.}
#'   \item{inherit}{The
#' number of times \dQuote{inherit} (or an extension, such as
#' \dQuote{inheritance}) appeared in the email.}
#'   \item{viagra}{The
...
#'
#' The exact statements being selected were: \enumerate{\item Government
#' regulations are necessary to encourage businesses and consumers to rely more
#' on renewable energy sources.  \item The private marketplace will ensure that
