...
#'
#' str(smoking)
#' histPlot(smoking$amt_weekends)
#' histPlot(smoking$amt_weekdays)
#' table(smoking$smoke, smoking$gender)
#' mosaicplot(~ smoke + marital_status, data = smoking)
#' barplot(sort(table(smoking$marital_status), decreasing = TRUE))
#'
"smoking"
